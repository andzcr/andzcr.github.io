   document.addEventListener('DOMContentLoaded', () => {
        ...
        // 1. STYLE INJECTION (Extra border animation tweak)
        ...
        // ==================================================
        // REUSABLE ROTATOR FUNCTION
        // Handles both the main slogan and the brand subtitle
        // ==================================================
        const initRotator = (containerId, intervalTime = 3000, initialDelay = 0) => {
            ...
            setTimeout(() => {
                setInterval(() => {
                    ...
                    void nextItem.offsetWidth; // Trigger Reflow
        ...
        // Initialize Main Slogan Rotator
        initRotator('main-rotator', 3000, 0);
        
        // Initialize Subtitle Rotator (Slightly offset timing for visual interest)
        initRotator('subtitle-rotator', 3500, 500);

        // ==================================================
        // SOCIAL SLIDER SMOOTH STOP (GSAP)
        // ==================================================
